 ...
 * @LastEditors: MaiChao
 * @LastEditTime: 2021-07-29 13:58:03
-->
<template>
  <div class="contents">
            ...
            <el-table-column prop="nickname"
              ...
              <template slot-scope='scope'>
                <div class="account-infor flex-ali-center cursor"
                     @click="toSearch(scope.row.userId)">
              ...
              <template>
                <div class="add-box">
                  <div class="search-box">
                    <el-input placeholder="请输入头条名称或者头条号"
                              v-model="keyword">
                    </el-input>
...
export default {
  ...
  methods: {
    ...
    // 切换日/周/月榜单
    openOther (type) {
      let url = type === '1' ? 'CustimizeDetail' : type === '2' ? 'CustimizeToutiaoArticle' : 'CustimizeToutiaoVideo'
    ...
    toSearch (id) {
      ...
      this.$router.push({ name: 'ReleaseRulesToutiao', query: { id: id } })
    }
  },
  created () {
