 ...
 * @LastEditors: MaiChao
 * @LastEditTime: 2021-06-02 18:39:50
-->
<template>
  <div class="contents">
...
export default {
  ...
  methods: {
    ...
    geListData () {
      ...
      this.$http.post(this.$api.userWbVideoData, this.ruleForm)
        .then(res => {
    ...
    // 切换日/周/月榜单
    openOther (type) {
      let url = type === '1' ? 'CustimizeWbDetail' : type === '2' ? 'CustimizeWbArticle' : 'CustimizeWbVideo'
