 ...
 * @LastEditors: MaiChao
 * @LastEditTime: 2021-06-02 18:20:04
-->
<template>
  <div class="">
    <div class="">
          ...
          <div class="flex-ali-center">
            ...
            <!-- <el-form-item prop="districts"
              ...
              <el-cascader size="small"
                           ...
                           placeholder="请选择地区" class="rank-select"></el-cascader>
            </el-form-item> -->
            <el-form-item>
          ...
          <el-table-column prop="status_title"
            ...
            <template slot-scope='scope'>
              <div class="account-infor flex-ali-center"
                ...
                <img :src="scope.row.media_url"
                     class="cursor"
                     alt="" v-if="scope.row.media_url">
  ...
  methods: {
    ...
    tabsTitle () {
      switch (this.ruleForm.dateType) {
        case 1:
          this.fileName = '最近一天微博视频排行榜'
          break
        case 2:
          this.fileName = '最近一周微博视频排行榜'
          break
        case 3:
          this.fileName = '最近一月微博视频排行榜'
          break
      }
    },
    // 加载更多
    ...
    // 获取类型
    getrankType () {
      this.$http.get(this.$api.wbType, { params: { type: '3' } })
        .then(res => {
          if (res.data.code === 200) {
            this.rankOption = []
    ...
    geListData () {
      ...
      this.$http.post(this.$api.getQYWeiboVideo, this.ruleForm)
        .then(res => {
