 ...
 * @LastEditors: MaiChao
 * @LastEditTime: 2021-08-03 14:46:37
-->
<template>
  <div class="">
    <div class="">
  ...
  methods: {
    ...
    tabsTitle () {
      switch (this.ruleForm.dateType) {
        case 1:
          this.fileName = '最近一天抖音视频排行榜'
          break
        case 2:
          this.fileName = '最近一周抖音视频排行榜'
          break
        case 3:
          this.fileName = '最近一月抖音视频排行榜'
          break
      }
    },
    // 加载更多
    ...
    geListData () {
      ...
      this.$http.post(this.$api.getQYToutiaoVideo, this.ruleForm)
        .then(res => {
