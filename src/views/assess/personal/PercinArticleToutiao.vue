 ...
 * @LastEditors: MaiChao
 * @LastEditTime: 2021-07-26 14:48:14
-->
<template>
  <div class="">
  ...
  methods: {
    ...
    tabsTitle () {
      switch (this.ruleForm.dateType) {
        case 1:
          this.fileName = '最近一天头条文章排行榜'
          break
        case 2:
          this.fileName = '最近一周头条文章排行榜'
          break
        case 3:
          this.fileName = '最近一月头条文章排行榜'
          break
      }
    },
    // 加载更多
    ...
    // 获取表格数据
    geListData () {
      this.$http.post(this.$api.getQYToutiaoArticle, this.ruleForm)
        .then(res => {
