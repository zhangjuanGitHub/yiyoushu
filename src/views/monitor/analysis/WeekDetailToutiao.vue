 ...
 * @LastEditors: MaiChao
 * @LastEditTime: 2021-07-29 18:16:52
-->
<template>
  <div class="detail content-show">
    <div class="tabs-header flex-ali-center">
      <el-breadcrumb separator-class="el-icon-arrow-right">
        ...
        <el-breadcrumb-item>头条分析详情</el-breadcrumb-item>
      </el-breadcrumb>
    </div>
    <div class="analysis-content">
      ...
      <div class="eight bac">
        <eight ref="EighthWb" :tableData='tableData' @fatherMethod="findArtileList"></eight>
...
<script>
import eight from '../components/EighthToutiao'
import ninth from '../components/NinthToutiao'
// import tenth from '../components/TenthToutiao'
import eleventh from '../components/EleventhToutiao'
// import twelfth from '../components/TwelfthToutiao'
import thirteenth from '../components/ThirteenthToutiao'
    ...
    getAnalyseList () {
      this.$http.get(this.$api.findAnalyseParticulars, { params: { id: this.ids } })
        .then(res => {
          ...
          this.$refs.EighthWb.getArticleData(this.userDataAll.chartNo3) // 发文趋势
          this.$refs.EighthWb.getArticleData2(this.userDataAll.chartNo5) // 发文时间分布

          this.$refs.NinthWb.getArticleData(this.userDataAll.chartNo4) // 阅读数
          this.$refs.NinthWb.getArticleTime(this.userDataAll.chartNo7) // 头条内容占比
