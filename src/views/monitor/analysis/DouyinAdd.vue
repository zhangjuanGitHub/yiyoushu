 ...
 * @LastEditors: MaiChao
 * @LastEditTime: 2021-08-04 10:27:45
-->
<template>
  <div class="interaction content-box">
    <div>
      <div class="add-main flex-cloumn-cen">
        ...
        <div class="add-main-center">
          <div class="add-task-duration">
            ...
            <p class="tips"
               v-if="this.duration==='1'">为您提供最近一周抖音数据报告</p>
            <p class="tips"
               v-else>为您提供最近一月抖音数据报告</p>
            <p class="title">抖音搜索</p>
          </div>
      ...
      <div class="list-box2" v-if="addList.length>0">搜索到<span>26</span>个结果</div>
      <div class="add-main-list list-box">
        <!-- <p class="">搜索到<span>26</span>个结果</p> -->
