 ...
 * @LastEditors: MaiChao
 * @LastEditTime: 2021-07-22 17:21:15
-->
<template>
  <div class="twins">
    <div class="table-bottm">
      <div class="title">头条行为数据分析</div>
      <div id="article-word">
        <div class="table-tabs flex-ali-center">
          <el-button :class="isOrigin==='digg_count'?'isActive':''"
                     size="small"
                     @click="tabsClick('digg_count')">点赞最高</el-button>
          <el-button :class="isOrigin==='comment_count'?'isActive':''"
                     size="small"
                     @click="tabsClick('comment_count')">评论最高</el-button>
          <el-button :class="isOrigin==='forward_count'?'isActive':''"
                     size="small"
                     @click="tabsClick('forward_count')">转发最高</el-button>
        </div>
        <div class="table-box">
