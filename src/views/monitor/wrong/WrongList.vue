    ...
    <div class="list-main-list"
      ...
      <div class="main-list-box"
        ...
        <div class="flex-bwt-center">
          ...
          <div>
            <p v-if="item.illegalStatus === -1" class="warning">监测中</p>
            <p v-else-if="item.illegalStatus === 0" class="success">无违规文章</p>
            <p v-else class="danger danger-border">监测到<span>{{item.illegalStatus}}</span>篇违规文章</p>
          </div>
