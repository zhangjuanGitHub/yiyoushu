    ...
    <div class="wx-warp-content">
      <div class="interaction-table">
        <el-table :data="tableData"
          ...
          <el-table-column prop="followCount"
                           label="关注总数"
                           width="135">
          </el-table-column>
...
export default {
  ...
  methods: {
    ...
    getTableData () {
      ...
      this.$http.post(this.$api.findInteractivityListWb, this.ruleForm)
        .then(res => {
    ...
    getWb (row) {
      // console.log(row)
      this.$router.push({ name: 'ReleaseRulesWb', query: { id: row.accountId } })
