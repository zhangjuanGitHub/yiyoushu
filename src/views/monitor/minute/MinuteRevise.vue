 ...
 * @Author: MaiChao
 * @@Description:修改预约监测
 * @Date: 2021-03-03 15:53:47
 * @LastEditors: MaiChao
 * @LastEditTime: 2021-03-03 15:57:42
-->
<template>
  <div class="minute-account">
    ...
    <div class="minute-content">
      <div class="minute-title">修改预约监测</div>
      ...
      <div class="minute-from">
        <el-form :model="ruleForm"
          ...
          <div class="bottom-button">
            <el-button type="primary"
                       @click="saveAngle()">保存修改</el-button>
            <el-button @click="cancelAngle()">取消</el-button>
          </div>
        </el-form>
      </div>
    </div>
