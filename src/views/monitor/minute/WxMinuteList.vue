 ...
 * @LastEditTime: 2021-06-03 16:16:07
-->
<template>
  <div class="minute-list">
    ...
    <div class="list-box">
            ...
            <div class="right-detail">
              ...
              <div class="right-bottom">
                <p class="lin-clamp">
                  ...
                  <span class="qudao" v-else-if="item.idx==='2'">次条</span>
                  <span class="qudao" v-else-if="item.idx==='3'">第三条</span>
                  <span class="qudao" v-else-if="item.idx==='4'">第四条</span>
                  <span class="qudao" v-else-if="item.idx==='5'">第五条</span>
                  <span class="qudao" v-else-if="item.idx==='6'">第六条</span>
                  <span class="qudao" v-else-if="item.idx==='7'">第七条</span>
                  <span class="qudao" v-else-if="item.idx==='8'">第八条</span>
      ...
      <div class="text-center"
        ...
        <p class="delete cursor" @click="$router.push({ name: 'WxMinuteBox', query: { tab: 'article' } })">暂无数据，请前往添加...</p>
      </div>
    </div>
...
export default {
  ...
  methods: {
    ...
    openMinute (item) {
      ...
      this.$router.push({ name: 'WxMinuteBox', query: { id: item.id, tab: tab } })
    },
    // 删除
    deleteItem (item) {
