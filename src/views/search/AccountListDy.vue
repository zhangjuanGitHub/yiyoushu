 ...
 * @LastEditTime: 2021-07-30 16:06:21
-->
<template>
            ...
            <div class="account-list-box">
              <div class="account-list-des flex-ali-center">
                <img class="account-list-ava cursor"
                     ...
                     @click="$router.push({ name: 'ReleaseRulesWb' , query: { id: item.uid }})">
...
export default {
  ...
  methods: {
    ...
    Searchkeyword () {
      if (this.accountActive === 'dy') {
        this.queryText = this.queryText.trim()
        if (this.queryText.length > 0 && this.queryText !== ' ') {
          this.$router.push({ name: 'AccountListDy', query: { type: this.accountActive, keyword: this.queryText } })
        } else {
