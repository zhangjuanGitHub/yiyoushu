 ...
 * @LastEditors: MaiChao
 * @LastEditTime: 2021-07-28 17:21:23
-->
<template>
            ...
            <el-table-column label="基本信息">
              <template slot-scope='scope'>
                <div class="more-msg-box flex-ali-center">
                  ...
                  <div class="more-msg-right flex-ali-center cursor" @click="target(scope.row.display_url)">
                    <!-- :style="{backgroundImage: 'url('+scope.row.original_pic+')' -->
                    <div class="more-cover-box cursor"
                         v-if="scope.row.image_url" @click="target(scope.row.display_url)">
                      <img :src="scope.row.image_url"
                           alt="">
                    </div>
                    <p class="lin-clamp-3 cursor"
                       v-html="scope.row.title"
                       @click="target(scope.row.display_url)"></p>
                  </div>
                </div>
              </template>
            </el-table-column>
